                        ...
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="login.html">
                                    Log In <img src="images/logout.png" alt="Log Out Icon" style="width: 20px; height: 20px;">
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="images/portrait-successful-mid-adult-doctor-with-crossed-arms.jpg" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="images/young-asian-female-dentist-white-coat-posing-clinic-equipment.jpg" class="img-fluid" alt="">
                                    </div>

                                    <div class="carousel-item">
                                        <img src="images/doctor-s-hand-holding-stethoscope-closeup.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="heroText d-flex flex-column justify-content-center">
                                ...
                                <p class="mb-4">Medic Care Laboratory is a trusted medical lab offering fast, reliable, and confidential diagnostic tests using modern technology and expert care.</p>

                                <div class="heroLinks d-flex flex-wrap align-items-center">
                                    <a class="custom-link me-4" href="{{ route('login') }}" data-hover="Log In">Log In</a>
                        ...
                        <div class="col-12">
                            ...
                            <div class="owl-carousel reviews-carousel">
                                ...
                                <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <img src="images/beautiful-woman-face-portrait-brown-background.jpeg" class="img-fluid reviews-image" alt="">
                                ...
                                <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <img src="images/senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpeg" class="img-fluid reviews-image" alt="">
                                ...
                                <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <img src="images/portrait-british-woman.jpeg" class="img-fluid reviews-image" alt="">
                                ...
                                <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded">
                                    ...
                                    <img src="images/woman-wearing-mask-face-closeup-covid-19-green-background.jpeg" class="img-fluid reviews-image" alt="">
