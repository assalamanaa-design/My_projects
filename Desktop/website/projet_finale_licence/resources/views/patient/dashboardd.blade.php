...
<div class="laboratory-dashboard">
    ...
    <div class="container">
        ...
        <div class="cardd patient-info">
            <div class="cardd-body">
                <h2>Welcome, <span class="patient-name">{{ Auth::user()->name ?? 'Patient' }}</span></h2>
                <p>{{ Auth::user()->email }}</p>
    ...
    <!-- Cancel form -->
    <form action="{{ route('patient.cancel.appointment', $nextAppointment->id) }}" method="POST" style="display:inline;">
        @csrf
        @method('DELETE')
...
<div class="modal fade" id="editAppointmentModal" tabindex="-1" role="dialog" aria-labelledby="editAppointmentModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
        ...
        <form method="POST" action="{{ route('patient.update.appointment', $nextAppointment->id) }}">
    @csrf
    @method('PUT')
